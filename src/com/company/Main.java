...
public class Main {
    ...
    public static void SearchByTerm(String search) throws IOException {
        boolean found = false;
        Scanner in = new Scanner(System.in);
        FileReader fr = new FileReader("C:\\Users\\JackN\\OneDrive\\Documents\\Computing\\terms.txt");
    ...
    public static void SearchDescriptionsForKeyword(String search) throws IOException{
        boolean found = false;
        FileReader fr = new FileReader("C:\\Users\\JackN\\OneDrive\\Documents\\Computing\\terms.txt");
        BufferedReader br = new BufferedReader(fr);
        String line = br.readLine();
